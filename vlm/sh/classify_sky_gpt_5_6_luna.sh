...
PROMPT_FILE="$VLM_DIR/prompts/sky.md"

DEFAULT_INPUT_DIR="/mnt/aigc/houyuanchen/pinterest-dl/light_repo/sky_merged"
DEFAULT_API_CONFIG="$VLM_DIR/api/gpt_5_6_luna.json"
DEFAULT_OUTPUT_DIR="$VLM_DIR/output/gpt_5_6_luna_sky"
...
if [[ "$TOTAL" -eq 0 ]]; then
    echo "No JPG, JPEG, or PNG images found in: $INPUT_DIR" >&2
    exit 2
fi
