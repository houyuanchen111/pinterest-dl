...
INPUT_DIR="${INPUT_DIR:-$VLM_DIR/output/gpt_5_6_luna_pin_657595983150761272_related_night_bokeh_lights/passed}"
SYSTEM_PROMPT="${SYSTEM_PROMPT:-$VLM_DIR/prompts/night_city_bokeh_lights_strict.zh.md}"
PROMPT_PROFILE="${PROMPT_PROFILE:-$VLM_DIR/prompts/night_city_bokeh_lights_strict.json}"
API_CONFIG="${API_CONFIG:-$VLM_DIR/api/gpt_5_6_luna.json}"
OUTPUT_DIR="${OUTPUT_DIR:-$VLM_DIR/output/gpt_5_6_luna_pin_657595983150761272_related_night_city_bokeh_lights_strict}"
WORKERS="${WORKERS:-200}"
TIMEOUT="${TIMEOUT:-180}"
RETRIES="${RETRIES:-3}"
MIN_SCORE="${MIN_SCORE:-88}"
