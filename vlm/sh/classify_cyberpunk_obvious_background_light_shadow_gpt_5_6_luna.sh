...
INPUT_DIR="${INPUT_DIR:-$VLM_DIR/output/gpt_5_6_luna_cyberpunk_neon_light_no_green/passed}"
PROMPT_FILE="${PROMPT_FILE:-$VLM_DIR/prompts/cyberpunk_obvious_background_light_shadow.zh.md}"
API_CONFIG="${API_CONFIG:-$VLM_DIR/api/gpt_5_6_luna.json}"
OUTPUT_DIR="${OUTPUT_DIR:-$VLM_DIR/output/gpt_5_6_luna_cyberpunk_obvious_background_light_shadow}"
WORKERS="${WORKERS:-200}"
TIMEOUT="${TIMEOUT:-180}"
RETRIES="${RETRIES:-3}"
