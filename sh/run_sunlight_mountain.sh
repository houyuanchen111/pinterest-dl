...
OUTPUT_ROOT=${OUTPUT_ROOT:-$REPO_DIR/light_repo/sunlight_mountain}
PYTHON=${PYTHON:-/mnt/aigc/houyuanchen/miniconda3/envs/diffsynth_studio/bin/python}
NUM=${NUM:-1000}
RETRY_DELAY=${RETRY_DELAY:-30}
QUERY_ZH=${QUERY_ZH:-"阳光 山"}
QUERY_EN=${QUERY_EN:-"sunlight mountain"}
...
run_query "sunlight_mountain_zh" "$QUERY_ZH" "$@"
run_query "sunlight_mountain_en" "$QUERY_EN" "$@"

echo "[$(date '+%F %T')] All sunlight mountain crawls completed."
