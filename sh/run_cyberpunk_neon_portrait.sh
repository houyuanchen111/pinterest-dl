...
run_query "cyberpunk_neon_portrait_zh" "赛博朋克 霓虹 人像" "$@"
run_query "cyberpunk_neon_portrait_en" "cyberpunk neon portrait" "$@"

echo "[$(date '+%F %T')] All cyberpunk neon portrait crawls completed."
